                    ...
                    <div className="container">
                        ...
                        <div style={styles.methodGrid}>
                            ...
                            <div style={styles.methodCard}>
                                <img src="/info_subject.png" alt="신고주체" style={styles.methodCardImage} />
                                <div style={styles.methodCardContent}>
                                    ...
                                    <ul style={styles.methodList}>
                                        ...
                                        <li style={styles.methodListItem}>
                                            <ChevronRight size={18} style={styles.methodBullet} />
                                            <span>피해자 이외의 제3자가 신고하는 경우 피해자의 동의가 있어야 조사 착수가 가능할 수도 있습니다.</span>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                            ...
                            {/* 2. 신고대상 */}
                            <div style={{ ...styles.methodCard, flexDirection: 'row-reverse' }}>
                                <img src="/info_target.png" alt="신고대상" style={styles.methodCardImage} />
                                <div style={styles.methodCardContent}>
                                    <div style={styles.methodCardHeader}>
                                    ...
                                    <div style={styles.splitGrid}>
                                        <div style={styles.splitGridLeft}>
                                            ...
                                            <ul style={styles.subList}>
                                                <li style={styles.subListItem}><span style={styles.listDot}>•</span> 직장 내 성희롱(육체적, 언어적, 시각적, 성적 요구 및 기타 행위)</li>
                                                <li style={styles.subListItem}><span style={styles.listDot}>•</span> 직장 내 괴롭힘(폭언·욕설 등 언어적 괴롭힘, 폭행 등 신체적 괴롭힘, 부당 지시 등 업무적 괴롭힘, 따돌림, 업무 외 사생활 침해 등)</li>
                                                <li style={styles.subListItem}><span style={styles.listDot}>•</span> 2차 가해(소문 유포, 비난, 사건 축소·은폐, 인사 불이익, 따돌림 등)</li>
                                                <li style={styles.subListItem}><span style={styles.listDot}>•</span> 기타 인권 침해 행위</li>
                                            </ul>
                                        </div>
                                        <div style={styles.splitGridRight}>
                                            <h4 style={styles.subHeading}><AlertTriangle size={18} color="#ef4444" /> 신고대상에 포함되지 않는 행위</h4>
                                            <ul style={styles.subList}>
                                                <li style={styles.subListItem}><span style={styles.listDot}>•</span> 당사자 간의 채권적 권리 관계 또는 계약상 의무 이행 여부 등</li>
                                                <li style={styles.subListItem}><span style={styles.listDot}>•</span> 고객사(기관)의 업무 진행에 관한 문의‧질의</li>
                                                <li style={styles.subListItem}><span style={styles.listDot}>•</span> 일반적‧주관적 불편사항 등 민원 관련 질의</li>
                            ...
                            {/* 3. 신고방법 */}
                            <div style={styles.methodCard}>
                                <img src="/info_method.png" alt="신고방법" style={styles.methodCardImage} />
                                <div style={styles.methodCardContent}>
                                    <div style={styles.methodCardHeader}>
                                    ...
                                    <ul style={styles.methodList}>
                                        ...
                                        <li style={styles.methodListItem}>
                                            ...
                                            <div style={styles.methodListContent}>
                                                <strong>서면신고</strong>
                                                <p style={{ margin: 0, lineHeight: 1.7 }}>서면신고 양식을 다운로드 받아 당 법무법인 방문 또는 우편접수<br /><span style={styles.textSmall}>[주소 : 서울 서초구 강남대로 291, 11층 (서초동, 남강빌딩)]</span></p>
                            ...
                            {/* 4. 신고유형 */}
                            <div style={{ ...styles.methodCard, flexDirection: 'row-reverse' }}>
                                <img src="/info_type.png" alt="신고유형" style={styles.methodCardImage} />
                                <div style={styles.methodCardContent}>
                                    <div style={styles.methodCardHeader}>
                                    ...
                                    <div style={styles.typeGrid}>
                                        ...
                                        <div style={styles.typeCard}>
                                            ...
                                            <ul style={styles.nestedList}>
                                                <li style={styles.nestedListItem}><span style={styles.listDot}>•</span> <span>신고자 정보를 드러내지 않고 신고하는 방법으로 신고자 조사가 어려워 사실 확인이 불가능한 경우 사전조사 단계에서 기각될 수 있습니다. 다만 신고자 조사 없이 피해자, 참고인 등을 통해 사실 확인이 가능한 경우 조사 절차가 진행됩니다.</span></li>
                                                <li style={styles.nestedListItem}><span style={styles.listDot}>•</span> <span><strong>신고자의 신원은 철저히 비밀로 유지되며, 고객사(기관) 담당자에게도 공개되지 아니합니다.</strong></span></li>
                                            </ul>
                                        </div>
                                    </div>
                                </div>
...
const styles = {
    ...
    flowchartRow: {
        ...
        flexWrap: 'nowrap',
        gap: '16px',
        overflowX: 'auto', // Allow scrolling on very small screens if needed
    ...
    flowStep: {
        ...
        flexDirection: 'column',
        alignItems: 'center',
        width: '120px', // slightly smaller width to fit 5 items
    },
    flowArrowBox: {
        display: 'flex',
        alignItems: 'center',
    ...
    stepDetailNumber: {
        fontSize: '26px',
        fontWeight: 800,
        color: 'var(--color-primary)', // Clear navy blue
        lineHeight: 1,
    },
    stepDetailTitle: {
        fontSize: '24px',
    ...
    stepDetailRight: {
        ...
        boxShadow: '0 4px 6px -1px rgba(0, 0, 0, 0.05)',
        border: '1px solid #f1f5f9',
        borderLeft: '8px solid #0f172a', // Dark navy blue line
        display: 'flex',
        alignItems: 'center',
        transition: 'transform 0.2s ease, box-shadow 0.2s ease',
    },
    stepDetailList: {
        ...
        display: 'flex',
        flexDirection: 'column',
        gap: '16px', // Increased gap between list items
    },
    stepDetailListItem: {
        display: 'flex',
        alignItems: 'flex-start',
